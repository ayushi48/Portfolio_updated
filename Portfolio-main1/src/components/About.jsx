...
const socials = [
  { icon: Github,    link: "https://github.com/ayushi48" },
  { icon: Linkedin,  link: "https://www.linkedin.com/in/ayushi-kumari48/" },
  { icon: Instagram, link: "https://www.instagram.com/ayushikumari9015?igsh=MWYyaml3bGI1MHEwZw==" },
  { icon: Mail,      link: "https://mail.google.com/mail/?view=cm&to=contact@ayushikumari.me" },
];
          ...
          <div className="w-full flex flex-col lg:flex-row justify-between items-start gap-6">
            ...
            <div className="w-full lg:w-[65%] pr-0">
              <p className="text-lg leading-8 text-justify font-serif">
                ...
                <span className="font-semibold text-pink-300">passionate full-stack web developer</span>{" "}
                ...
                <span className="font-semibold text-violet-300">React and Tailwind CSS</span>,
              ...
              <p className="text-lg leading-8 mt-4 text-justify font-serif">
                ...
                <span className="font-semibold text-green-300">intuitive, efficient, and easy to use</span>.
                I continuously refine code quality, experiment with modern web technologies,
                and follow best practices to build{" "}
                <span className="font-semibold text-green-300">scalable and maintainable solutions</span>.
              </p>

              <p className="text-lg leading-8 mt-4 text-justify font-serif">
                Alongside web development, I actively strengthen my{" "}
                <span className="font-semibold text-blue-300">problem-solving and logical reasoning</span>{" "}
                by practicing{" "}
                <span className="font-semibold text-red-300">Data Structures and Algorithms</span>.
              ...
              <p className="text-lg leading-8 mt-4 text-justify font-serif">
                <span className="font-semibold text-yellow-300">Key Skills & Technologies: </span>
