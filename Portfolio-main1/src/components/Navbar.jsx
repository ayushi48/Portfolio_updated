...
//       <div className={`${styles.paddingX} w-[95%] rounded-3xl flex items-center py-3 fixed top-0 z-20 ${scrolled ? "bg-primary" : "bg-transparent"}`}>
//         <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
...
//                 group-hover:after:scale-x-100 uppercase
//               "
//             >
//               Ayushi&nbsp;
//               <span className="sm:block hidden text-secondary font-medium ml-1">
...
//           {/* ── Desktop nav: reduced gap-6, items-center ── */}
//           <ul className='list-none hidden sm:flex flex-row gap-6 items-center'>
//             {navLinks.map((nav) => (
//               <li
//                 key={nav.id}
//                 className={`
//                   relative text-[15px] font-medium cursor-pointer transition-all duration-300
