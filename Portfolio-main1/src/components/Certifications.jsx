...
// import cert1 from "../assets/certificates/certificate1.pdf";
// import cert2 from "../assets/certificates/certificate2.pdf";
...
//         {/* Prize emoji — no box, just the emoji */}
//         <div style={{
...
//       {/* <p style={{
//         marginTop: "1.8rem", fontSize: 12,
//         color: "#3d4451", fontFamily: "'Courier New', monospace",
//         letterSpacing: "0.05em",
//       }}>
//         <span style={{ color: "#8b5cf6" }}>// </span>
//         click download to save certificate to your device
//       </p> */}
//     </div>
//   </section>
// );
  ...
  return (
    ...
    >
      ...
      <span style={{
        ...
        /* ↓ smaller padding & font for mobile feel */
        padding: "5px 12px",
        borderRadius: 50,
        border: `1.5px solid ${hovered ? "rgba(145,94,255,1)" : "rgba(145,94,255,0.65)"}`,
        background: hovered ? "rgba(145,94,255,0.12)" : "rgba(10,10,15,0.9)",
